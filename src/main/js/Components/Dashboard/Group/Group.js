    ...
    return <div className='group_container'>
        <div className='group_header'>
            ...
            <div className='btn-group'>
                <button type="button" onClick={handleShowAddShortcutModal} className="btn btn-dark btn-sm">Add
                    shortcut
                </button>
                <button type="button" onClick={handleToggleEditShortcuts} className="btn btn-dark btn-sm">Toggle
                    shortcut editing
                </button>
                <button type="button" onClick={handleShowEditGroupModal} className="btn btn-dark btn-sm">Edit group
                </button>
            </div>
        </div>
