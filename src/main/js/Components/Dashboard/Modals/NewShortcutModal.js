...
function NewShortcutModal(props) {
    ...
    return <Modal centered show={props.show} className='' onHide={handleCloseAddShortcutModal}>
        ...
        <Modal.Body>
            <form className="mb-2">
                <input type='text' placeholder="Shortcut name" onChange={handleName} value={name}
                       className='form-control my-1'/>
                <input type='text' placeholder="A quick description (optional)" onChange={handleDesc}
                       value={description} className='form-control my-1'/>
                <input type='url' placeholder="Image URL" onChange={handleIcon} value={icon}
                       className='form-control my-1'/>
                <input type='url' placeholder="Targeted website URL" onChange={handleUrl} value={url}
                       className='form-control my-1'/>
